...
//void printCharToLCD(char* message, BYTE l, BYTE p);
void dataLCD(const BYTE c);
void customCharToLCD(const BYTE c, char bal[8], BYTE l,  BYTE p, BYTE b);
void installLCD(unsigned char bal[8], const BYTE g);
//	Structures
